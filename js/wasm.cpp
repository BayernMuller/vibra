...
Fingerprint* EMSCRIPTEN_KEEPALIVE GetWavSignature(char* raw_wav,
                                                  int wav_data_size) {
  return vibra_get_fingerprint_from_wav_data(raw_wav, wav_data_size);
}

Fingerprint* EMSCRIPTEN_KEEPALIVE GetSignedPcmSignature(char* raw_pcm,
                                                        int pcm_data_size,
                                                        int sample_rate,
                                                        int sample_width,
                                                        int channel_count) {
...
Fingerprint* EMSCRIPTEN_KEEPALIVE GetFloatPcmSignature(char* raw_pcm,
                                                       int pcm_data_size,
                                                       int sample_rate,
                                                       int sample_width,
                                                       int channel_count) {
